                    ...
                    <div className=" p-4  h-screen flex flex-col overflow-y-scroll no-scrollbar">
                        {
                            subDatas?.subCategories?.map((item) => (
                                <Link to={`/elanlar/${subDatas.path}/${item.path}`} target="_blank" rel="noopener noreferrer" className="group w-full h-[55px] font-normal border-b border-opacity-50 flex items-center  gap-4 ">
